...
class ClientThread extends Thread
{
  ...
  static Logger logger = LoggerFactory.getLogger(ClientThread.class);
  /**
   * Constructor.
   *
  ...
  public void run()
  {
    logger.debug(" TAG!! {} ",_props.getProperty("writeQoS"));
    try
    {
      _db.init(_props.getProperty("readQoS"),_props.getProperty("writeQoS"),_props.getProperty("scanQoS"));
    }
    catch (DBException e)
    {
      e.printStackTrace();
...
public class Client
{
  ...
  /**
   * This is for logging the output
   */
  ...
  public static void main(String[] args)
  {
    ...
    logger.debug("Logging from Client");
    //parse arguments
    int argindex=0;
    ...
    //Setting ReadQoS
    props.setProperty("readQoS","10");
    props.setProperty("writeQoS","5");
    props.setProperty("scanQoS","15");
