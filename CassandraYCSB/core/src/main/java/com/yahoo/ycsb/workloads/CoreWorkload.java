...
public class CoreWorkload extends Workload
{
	...
	/**
	 * The Logger using the log4j Logging Framework
	 */
	 private static Logger logger = LoggerFactory.getLogger(CoreWorkload.class);
	 ...
	 * DefaultKey that every read will query using 
	 */
  ...
  private String buildDeterministicValue(String key, String fieldkey) {
	...
	public boolean doTransaction(DB db, Object threadstate)
	{
		...
		logger.debug("Going to do a read now");
		...
		try{
			PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("/root/ResponseNumbers", true))) ;
  ...
  protected void verifyRow(String key, HashMap<String,ByteIterator> cells) {
	...
	{
		/* Cassandra Team Modification */
		if (staticKeyName==null)
		{
			//choose a random key
			int keynum = nextKeynum();
			this.staticKeyName=buildKeyName(keynum);
		}
			
		String keyname= staticKeyName; 
